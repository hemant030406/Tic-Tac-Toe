        ...
        <div id="footer">
            <div id="complete">
                <div id="ig">
                    ...
                    <i className="fa-brands fa-github fa-2xl" style={{ marginTop: '1.7rem' }}></i>
                    <a href="https://github.com/hemant030406/Tic-Tac-Toe" target="blank" style={{ textDecoration: "none", color: 'rgb(254 188 205)', marginLeft: '0.7rem' }}>Source Code</a><br></br>
